          ...
          <p>
            ...
            <Tooltip placement="topLeft" title="Install date">
              <span className={styles.fontSize13}>
                {getBrowserLocaledDateTimeString(itemData['install-date'])}
              </span>
            </Tooltip>
            <Tooltip placement="topLeft" title="Quantity">
              <span className={styles.fontSize13}>Qty: {itemData.quantity}</span>
            </Tooltip>
          </p>
          <p>
            <Tooltip placement="topLeft" title="Condition">
              <span className={styles.fontSize13}>Condition: {itemData.condition}</span>
            </Tooltip>
